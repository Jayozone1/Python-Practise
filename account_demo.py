#This program creates an instance of the SavingsAccount class and an instance of the CD acccount.

import accounts

def main():
    #Get the account number, interest rate, and account balance for a sacing account.
