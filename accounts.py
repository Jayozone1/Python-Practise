#The SavingsAccount class represents a saving account.

class SavingsAccount:

    #The __init__method accepts arguments for the account number, interest rate, and balance.
...
# The set_maturity_date is a mutator for the _ _maturity_date attribute.

    def set_maturity_date(self, mat_date):
        self.__maturity_date = mat_date

 # The get_maturity_date method is an accessor for the _ _maturity_date attribute. 
