#This program displays step-by-step instructions for disassembiling an Acme dryer.
#The main function performs th eprogram's main logic.
def main():
...
def startup_message():
    print('This program tells you hoe to dissamble an ACME laundry dryer.')
...
#The step2function displays the instructions for step 2.
def step2():
