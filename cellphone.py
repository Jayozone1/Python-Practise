...
class Cellphone:
    ...
    #  The __init__ method initializes teh attributes.
    ...
    #The set_manufact method accepts an argumnet for the phone's manufacturer.
    ...
    #The get_model method returns the phone's retail price.
