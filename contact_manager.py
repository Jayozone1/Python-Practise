...
#The change function changes an existing entry int he specified dictionary.
...
#The save_contacts function pickles the specified objects and saves it to the contact file.
